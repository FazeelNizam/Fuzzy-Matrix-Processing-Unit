...
set rc [catch {
  ...
  open_checkpoint FMU_routed.dcp
  ...
  catch { write_mem_info -force FMU.mmi }
  write_bitstream -force FMU.bit 
  catch {write_debug_probes -quiet -force FMU}
  catch {file copy -force FMU.ltx debug_nets.ltx}
