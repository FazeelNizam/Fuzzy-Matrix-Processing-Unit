...
begin
    ...
    begin
        ...
        -- CU is now fetching the first instruction. Wait for rom_ena.
        ...
        -- It will request more bytes from the instruction register.
        -- We will provide them on irdata. It does not re-enable ROM.
        -- State SET0 -> SET1: needs base address
