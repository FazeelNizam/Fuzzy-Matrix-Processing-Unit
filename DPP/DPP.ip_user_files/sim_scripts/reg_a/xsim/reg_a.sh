...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L secureip -L xpm --snapshot reg_a xil_defaultlib.reg_a -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim reg_a -key {Behavioral:sim_1:Functional:reg_a} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb reg_a.wdb xsim.dir)
