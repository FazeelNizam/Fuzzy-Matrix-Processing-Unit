...
#
# Generated by export_simulation on Sat Aug 09 23:49:28 +0530 2025
#
################################################################################
...
'-reset_run' switch to the './reg_a.sh' script.
...
./reg_a.sh -noclean_files

For more information on the script, please type './reg_a.sh -help'.
